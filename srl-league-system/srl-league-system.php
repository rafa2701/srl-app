...
define( 'SRL_PLUGIN_VERSION', '1.0.2' );
...
require_once SRL_PLUGIN_PATH . 'includes/shortcodes.php'; // <-- AÑADIDO

// --- Hooks ---

/**
 * Añade la página de gestión al menú de administración.
 */
...
/**
 * Encola los scripts y estilos para el panel de administración.
 */
...
/**
 * Encola los estilos para el frontend (páginas públicas).
 * Se cargarán en cualquier página que use nuestro shortcode.
 */
function srl_public_enqueue_styles() {
    wp_enqueue_style(
        'srl-public-css',
        SRL_PLUGIN_URL . 'assets/css/main.css', // El CSS que creamos al principio
        [],
        SRL_PLUGIN_VERSION
    );
}
add_action( 'wp_enqueue_scripts', 'srl_public_enqueue_styles' ); // <-- AÑADIDO
