...
function srl_register_protest_post_type() {
    $labels = [
        'name'                  => _x( 'Denuncias', 'Post Type General Name', 'srl-league-system' ),
        'singular_name'         => _x( 'Denuncia', 'Post Type Singular Name', 'srl-league-system' ),
        'menu_name'             => __( 'Comisariato (Denuncias)', 'srl-league-system' ),
        'name_admin_bar'        => __( 'Denuncia', 'srl-league-system' ),
        'archives'              => __( 'Archivo de Denuncias', 'srl-league-system' ),
        'attributes'            => __( 'Atributos de Denuncia', 'srl-league-system' ),
        'parent_item_colon'     => __( 'Denuncia Padre:', 'srl-league-system' ),
        'all_items'             => __( 'Todas las Denuncias', 'srl-league-system' ),
        'add_new_item'          => __( 'Nueva Denuncia', 'srl-league-system' ),
        'add_new'               => __( 'Añadir Nueva', 'srl-league-system' ),
        'new_item'              => __( 'Nueva Denuncia', 'srl-league-system' ),
        'edit_item'             => __( 'Revisar Denuncia', 'srl-league-system' ),
        'update_item'           => __( 'Actualizar Denuncia', 'srl-league-system' ),
        'view_item'             => __( 'Ver Denuncia', 'srl-league-system' ),
        'view_items'            => __( 'Ver Denuncias', 'srl-league-system' ),
        'search_items'          => __( 'Buscar Denuncias', 'srl-league-system' ),
        'not_found'             => __( 'No se encontraron denuncias', 'srl-league-system' ),
        'not_found_in_trash'    => __( 'No hay denuncias en la papelera', 'srl-league-system' ),
    ];

    $args = [
        'label'                 => __( 'Denuncia', 'srl-league-system' ),
        'description'           => __( 'Denuncias de incidentes en pista para análisis del Comisariato Virtual', 'srl-league-system' ),
        'labels'                => $labels,
